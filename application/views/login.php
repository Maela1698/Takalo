        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" action = "<?php echo site_url('login/controlLogin'); ?>" method = "post" >
                <div class="form-group">
                  <input type="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Mail" name = "mail">
                </div>
                <div class="form-group">
                ...
                <?php 
                    if(isset($erreur)){ ?>
                        <p style = "text-align:center; color:red"> <?php echo $erreur; ?> </p>
                <?php } ?>
                <div class="mt-3">
                ...
                <div class="text-center mt-4 font-weight-light">
                  Don't have an account? <a href="<?php echo site_url('login/inscription') ?>" class="text-primary">Create</a>
                </div>
              </form>
            </div>
          </div>
